...
# eosio-cpp -abigen -R contracts/$RELAY/resource -contract $RELAY -o $RELAY.wasm contracts/$RELAY/src/$RELAY.cpp -I contracts/$RELAY/include -I contracts/$TOKEN/include -I contracts/$SYSTEM/include
...
eosio-cpp -abigen -R contracts/$FAUCET/resource -contract $FAUCET -o $FAUCET.wasm contracts/$FAUCET/src/$FAUCET.cpp -I contracts/$FAUCET/include -I contracts/$TOKEN/include -I contracts/$SYSTEM/include
