...
eosio-cpp -abigen -R contracts/$FAUCET/resource -contract $FAUCET -o $FAUCET.wasm contracts/$FAUCET/src/$FAUCET.cpp -I contracts/$FAUCET/include -I contracts/$TOKEN/include
