...
# eosio-cpp -abigen -R contracts/$NAMES/resource -contract $NAMES -o ./dist/$NAMES.wasm contracts/$NAMES/src/$NAMES.cpp -I contracts/$NAMES/include -I contracts/$TOKEN/include